...
class Settings_Route extends WP_REST_Controller
{
    ...
    public function create_items($request)
    {
        ...
        update_option('wlsale_settings_firstname', $firstname);
        update_option('wlsale_settings_lastname', $lastname);
        update_option('wlsale_settings_email', $email);
